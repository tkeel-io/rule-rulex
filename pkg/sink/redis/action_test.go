...
var rawMsg = `{
"rawMsg":{
"event_id": "message-OPC.1",
"event_type": "info",
"event_name": "ABC",
"event_level": "low",
"create_time": 1576737423000,
"message": "124",
  "source": "iotd-aaa",
  "noticeList": "string",
  "deviceId":"xxxx"
...
var matedata = map[string]string{//root:123456@tcp(127.0.0.1:3306)/iot_manage?charset=utf8
    ...
    "table": "test",
    "urls": [
      "redis://:123456@139.198.36.134:6379/0"
    ]
  }`,
}
...
func (this *Action) Setup() {
	...
	this.cancel = cancel
	this.ac = newRedis("redis", "iotd-1234")
	if err := this.ac.Setup(this.ctx, matedata); err != nil {//初始化mysql
