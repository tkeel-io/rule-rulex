...
const (
	CLICKHOUSE_DB               = `CREATE DATABASE IF NOT EXISTS iot_manage`
	CLICKHOUSE_IOT_THING_CREATE = `CREATE TABLE iot_manage.device_thing_data (
				time 					UInt64,
				user_id 				String,
				device_id 				String,
				source_id 				String,
	...
	CLICKHOUSE_IOT_DEVICE_EVENT_DATA = `CREATE TABLE iot_manage.device_event_data (
				device_id 		String,
				source_id 		String,
				event_id   	    String,
				identifier		String,
